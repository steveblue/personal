...
var css_248z$9 = ":host{display:block;width:100vw;height:100vh;overflow-y:scroll}:host h2{font-family:var(--headline-font);font-size:2em;font-weight:700}:host p{font-size:1.4em}.i--center{position:absolute;top:50%;left:50%;transform:translateX(-50%) translateY(-50%);text-align:center}";
...
var css_248z$a = ":host{display:block;width:100vw;height:100vh;overflow-y:scroll;position:relative}:host .post__wrapper{overflow:hidden;position:relative;left:50%;transform:translateX(-50%)}:host h1{font-family:var(--headline-font);font-size:4em;font-weight:900}:host p{font-size:1.4em}@media (min-width:768px) and (max-width:1023px){:host .post__wrapper{max-width:640px}:host h1{font-size:3em}}@media (min-width:1024px) and (max-width:1359px){:host .post__wrapper{max-width:720px}}@media (min-width:1360px) and (max-width:1879px){:host .post__wrapper{max-width:840px}}@media (min-width:1880px){:host .post__wrapper{max-width:840px}}";
styleInject(css_248z$a);

var template$a = "<v-nav></v-nav>\n<v-stage>\n    <v-section data-index=\"0\">\n        <t-post theme=\"is--light\">\n            <div class=\"post__wrapper\">\n                <h1>Blog</h1>\n            </div>\n        </t-post>\n    </v-section>\n</v-stage>";
...
var css_248z$b = ":host{display:block;width:100vw;height:100vh;overflow-y:scroll;position:relative}:host .resume__wrapper{overflow:hidden;position:relative;left:50%;transform:translateX(-50%)}:host .resume__wrapper .job header{display:flex;justify-content:space-between}:host .resume__wrapper .job header .icon__header{display:flex}:host .resume__wrapper .job:last-child{margin-bottom:120px}:host .resume__wrapper h1{font-family:var(--headline-font);font-size:4em;font-weight:900}:host .resume__wrapper h3{-webkit-margin-after:0;margin-block-end:0}@media (max-width:767px){:host .resume__wrapper{max-width:300px}:host .resume__wrapper h1{font-size:3em}}@media (min-width:768px) and (max-width:1023px){:host .resume__wrapper{max-width:640px}}@media (min-width:1024px) and (max-width:1359px){:host .resume__wrapper{max-width:720px}}@media (min-width:1360px) and (max-width:1879px){:host .resume__wrapper{max-width:840px}}@media (min-width:1880px){:host .resume__wrapper{max-width:840px}}";
