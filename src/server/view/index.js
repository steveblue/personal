...
class NodeTree {
  ...
  updateNode(node, key, value) {
    ...
    const attrId =
      this.getElementByAttribute(node)[0].nodeName ||
      this.getElementByAttribute(node)[0].name;
...
function State(property) {
  return function decorator(target, key, descriptor) {
    function bindState() {
      ...
      this.$$state['node' + BIND_SUFFIX] = new BoundNode(
...
var css =
  ':host{display:block;opacity:0;border-radius:6px;border:1px solid var(--font-color);width:640px;height:480px;position:absolute;left:50%;top:50%;transform:translate3D(-50%,-50%,0);transform-origin:50% 50%;background-color:var(--body-color)}@media screen and (max-width:640px){:host{width:300px;height:320px;left:0}}';
styleInject(css);
...
var css$1 =
  ':host{display:block;position:relative;width:0;height:0%;perspective:1000px}';
styleInject(css$1);
...
var css$4 =
  ':host{display:flex;width:100vw;height:640px;justify-content:center;align-items:center}';
styleInject(css$4);
...
var css$5 =
  ':host{display:block;width:100vw;height:100vh}.i--center{position:absolute;top:50%;left:50%;transform:translateX(-50%) translateY(-50%);text-align:center}';
styleInject(css$5);
