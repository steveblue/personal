...
import style from './photographer-heading.css?raw';
import template from './photographer-heading.html?raw';
...
@Component({
  selector: 't-photoheading',
  style: style,
  template: template,
})
class PhotographerHeadingComponent extends CustomElement {
...
export { PhotographerHeadingComponent };
